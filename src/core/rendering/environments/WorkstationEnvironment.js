...
export class WorkstationEnvironment extends BaseEnvironment {
  constructor(options = {}) {
    super({
      ...options,
      usePostProcessing: true, // WORK requires post-processing for the fluorescent light effect
  ...
  async initializeScene() {
    ...
    // Set work-specific scene properties
  ...
  update(deltaTime) {
    ...
    // Add work-specific updates here
  ...
  dispose() {
    ...
    // Clean up work-specific resources
   ...
   * Currently, WORK has no interactables, so returns an empty array.
