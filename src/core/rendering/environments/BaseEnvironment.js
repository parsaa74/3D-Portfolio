...
export class BaseEnvironment {
  ...
  async initializeRenderer() {
    ...
    // Enable modern physically correct lighting for realistic material appearance
    this.renderer.useLegacyLights = false;
    
    // Set tone mapping for better overall brightness and contrast
    this.renderer.toneMapping = THREE.ACESFilmicToneMapping;
    this.renderer.toneMappingExposure = 1.4; // Increased from 1.0 for brighter overall lighting
