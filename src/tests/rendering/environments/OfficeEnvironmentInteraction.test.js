...
describe("OfficeEnvironment Poster E Button Interaction", () => {
  let env, camera;

  beforeEach(async () => {
    env = new OfficeEnvironment();
  ...
  it("sets correct infoContent and imageUrls for Friends poster", () => {
    // Arrange
    const env = new OfficeEnvironment();
    ...
    const interactMesh = env.addInfoInteractionToArtPoster
      ...
      : OfficeEnvironment.prototype.addInfoInteractionToArtPoster.call(env, imageGroup, position, interiorGroup, posterTitle);
